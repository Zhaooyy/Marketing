...
public class StrategyRepository implements IStrategyRepository {
    ...
    @Override
    public void storeStrategyAwardSearchRateTable(String key, int rateRange, HashMap<Integer, Integer> shuffleStrategyAwardSearchRateTables) {
    ...
    public Integer getStrategyAwardAssemble(String key, int rateKey) {
        return (Integer) redisService.getFromMap(Constants.RedisKey.STRATEGY_RATE_TABLE_KEY + key, rateKey);
    }
